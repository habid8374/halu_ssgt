...
const NAV_POR_ROL: Record<string, ItemNav[]> = {
  ...
  coordinador: [
    ...
    { href: "/gerencia/profesiogramas", label: "Profesiogramas", icono: "📋" },
    ...
    { href: "/gerencia/glosas", label: "Glosas", icono: "⚖️" },
  ...
  empresa_cliente: [
    ...
    { href: "/portal-empresa/autorizaciones", label: "Autorizaciones", icono: "✅" },
